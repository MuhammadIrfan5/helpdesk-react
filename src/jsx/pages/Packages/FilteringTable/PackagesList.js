...
export const PackagesList = () => {
  ...
  const listPackages = async () => {
    ...
    await axios(config)
      .then(function (response) {
        ...
        console.log(response, "package list response");
  ...
  const DeleteComplaint = () => {
    ...
    var config = {
      method: "post",
      maxBodyLength: Infinity,
      url: `${apiActiveURL}admin/packages/delete_package`,
      headers: {
        Accept: "application/json",
        Authorization: `Bearer ${loginData?.data?.token}`,
        // ...data.getHeaders(),
  ...
  const handleUpdate = (item) => {
    ...
    setPackageCost(item.original.package_cost);
    setPackageName(item.original.name);
  ...
  const updatePackages = async (e) => {
    ...
    var config = {
      method: "post",
      maxBodyLength: Infinity,
      url: `${apiActiveURL}admin/packages/update_package`,
